...
const PeoplePage = () => {
    ...
    return (
        <Container className="mt-3">
            <Row>
                <Col md={4}>
                    <Image width={300} heght={300} src={'http://localhost:5000/' + people.img}/>
                </Col>
                <Col md={4}>
                ...
                <Col md={4}>
                    ...
                    >Поставити плюсик</Button>
                    <EnterPlusForPeople show={comentVisible} onHide={() => setComentVisible(false)}/>
                    </Card>
                </Col>
            </Row>
